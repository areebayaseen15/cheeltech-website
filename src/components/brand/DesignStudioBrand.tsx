"use client";
import abouticon1 from "../../../public/assets/img/companies-logos/bnc-logo.png";
import abouticon2 from "../../../public/assets/img/companies-logos/vme-logo.png";
import abouticon3 from "../../../public/assets/img/companies-logos/markabe logo 2.png";
import abouticon4 from "../../../public/assets/img/companies-logos/brandopurtunity-logo.png";
import abouticon5 from "../../../public/assets/img/companies-logos/Prepay Nation.png";
import abouticon6 from "../../../public/assets/img/companies-logos/imp-logo.png";
import abouticon7 from "../../../public/assets/img/companies-logos/Assendive.png";
...
const DesignStudioBrand = () => {
    // Brand logo data
    const brandLogos = [abouticon1, abouticon2, abouticon3, abouticon4, abouticon5, abouticon6, abouticon7];

    // Double the logos for seamless animation
    const movingBrandLogos = [...brandLogos, ...brandLogos.slice(0, 2)];

    return (
        <div className="des-brand-area pb-40">
