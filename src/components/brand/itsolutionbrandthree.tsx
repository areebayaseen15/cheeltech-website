...
const ITSolutionBrandThree = () => {
    ...
    return (
        <div className="creative-brand-area it-brand-style text-center paste-bg-2 p-relative pt-20 pb-20">
...
export default ITSolutionBrandThree;