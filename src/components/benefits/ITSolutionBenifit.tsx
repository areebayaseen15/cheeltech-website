    ...
    const benefitsData: BenefitItemDT[] = [
        {
            ...
            description: "We bring visions to life with innovative ideas boosting engagement.",
            link: "#"
        },
        {
            id: 2,
            ...
            description: "We provide sensibly priced services and fair pricing for startups.",
            link: "#"
        },
        {
            id: 3,
            ...
            description: " We optimize speed and ad placements to build high-performing platforms.",
            link: "#"
        }
    ];
    ...
    return (
        <div className="it-benifit-area p-relative pt-120 pb-120">
            <div className="container container-1230">
                <div className="it-benifit-bg z-index-1" style={{ backgroundColor: "#ebebff" }}>
                        ...
                        {benefitsData.map((benefit) => (
                            <div className="col-lg-4" key={benefit.id}>
                                <div className="it-benifit-item">
                                    <div className="it-benifit-icon bg-blue-1">
