...
const ITSolutionTestimonial = () => {
    return (
        <div className="it-testimonial-area it-testimonial-ptb pt-40 pb-40">
            <div className="container container-1230">
                <div className="row justify-content-center">
                    <div className="col-lg-8 col-md-12">
                        <div className="it-testimonial-title-box text-center mb-50">
                            <span className="tp-section-subtitle-platform platform-text-black mb-20 tp-split-text tp-split-right"> Feedbacks</span>
                            <h4 className="tp-section-title-platform platform-text-black mb-20 tp-split-text tp-split-right">Trusted by Forward-Thinking 
Businesses </h4>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">
                    <div className="col-xl-8">
                        <div className="it-testimonial-slider-wrap p-relative">
                            ...
                            >
                                {testimonialsData.slice(0, 9).map((testimonial) => (
